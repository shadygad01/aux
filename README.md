...
The dashboard also surfaces a "Reversal Signal Start" watch: H1 prints a BOS
or CHoCH inside the premium zone while bullish and MACD is still positive
(`WATCH_SELL`), or inside the discount zone while bearish and MACD is still
negative (`WATCH_BUY`). This is a heuristic pattern watch, not a tested edge
-- a closely related premium/discount structural-break reversal rule (H-028)
was evaluated against five years of tick data and rejected; see
